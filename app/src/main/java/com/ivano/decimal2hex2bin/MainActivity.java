...
import java.math.BigInteger;  //la RAM ne limita il valore massimo
...
public class  MainActivity extends Activity {
        ...
        Button DtoH, B0,B1,B2,B3,B4,B5,B6,B7,B8,B9,  esci, riazzera, go2b, go2h, go2oct;
         ...
         @Override  //***used to mark methods that override a method declaration in a superclass.
           ...
           // display2.setTextIsSelectable(true);
                ...
                go2b.setOnClickListener(new View.OnClickListener() {
                  public void onClick(View arg0) {
                      Intent i = new Intent(MainActivity.this, My3rdScreen.class);
                  startActivity(i);
            ...
            go2h.setOnClickListener(new View.OnClickListener() {
              public void onClick(View arg0) {
                      Intent i = new Intent(MainActivity.this, MyNewScreen.class);
                  startActivity(i);
                  finish();
              }});
           ...
           //vai alla activity per input ottale
            ...
            go2oct.setOnClickListener(new View.OnClickListener() {
              public void onClick(View arg0) {
                      Intent i = new Intent(MainActivity.this, OctalActivity.class);
                  startActivity(i);
                  finish();
              }});
                  ...
                  B0.setOnTouchListener(new OnTouchListener() {
                      public boolean onTouch(View v, MotionEvent event) {
                          if (event.getAction() == MotionEvent.ACTION_DOWN) {
                              ...
                              val_inserito= ValInserito(BigInteger.valueOf(10), val_inserito, BigInteger.ZERO);
                          }
...
*************/
            ...
            B1.setOnClickListener(new View.OnClickListener() {
              public void onClick(View v) {
                      val_inserito= ValInserito(BigInteger.valueOf(10), val_inserito, BigInteger.valueOf(1));
                    }});

            B2 = (Button) findViewById (R.id.button2);
            B2.setOnClickListener(new View.OnClickListener() {
              public void onClick(View v) {
                      val_inserito= ValInserito(BigInteger.valueOf(10), val_inserito, BigInteger.valueOf(2));
                    }});

            B3 = (Button) findViewById (R.id.button3);
            B3.setOnClickListener(new View.OnClickListener() {
              public void onClick(View v) {
                      val_inserito= ValInserito(BigInteger.valueOf(10), val_inserito, BigInteger.valueOf(3));
                    }});

            B4 = (Button) findViewById (R.id.button4);
            B4.setOnClickListener(new View.OnClickListener() {
              public void onClick(View v) {
                      val_inserito= ValInserito(BigInteger.valueOf(10), val_inserito, BigInteger.valueOf(4));
                    }});

            B5 = (Button) findViewById (R.id.button5);
            B5.setOnClickListener(new View.OnClickListener() {
              public void onClick(View v) {
                      val_inserito= ValInserito(BigInteger.valueOf(10), val_inserito, BigInteger.valueOf(5));
                    }});

            B6 = (Button) findViewById (R.id.button6);
            B6.setOnClickListener(new View.OnClickListener() {
              public void onClick(View v) {
                      val_inserito= ValInserito(BigInteger.valueOf(10), val_inserito, BigInteger.valueOf(6));
                    }});
            ...
            B7.setOnClickListener(new View.OnClickListener() {
              public void onClick(View v) {
                      val_inserito= ValInserito(BigInteger.valueOf(10), val_inserito, BigInteger.valueOf(7));
                    }});

            B8 = (Button) findViewById (R.id.button8);
            B8.setOnClickListener(new View.OnClickListener() {
              public void onClick(View v) {
                      val_inserito= ValInserito(BigInteger.valueOf(10), val_inserito, BigInteger.valueOf(8));
                    }});

            B9 = (Button) findViewById (R.id.button9);
            B9.setOnClickListener(new View.OnClickListener() {
              public void onClick(View v) {
                      val_inserito= ValInserito(BigInteger.valueOf(10), val_inserito, BigInteger.valueOf(9));
                    }});
 ...
 ********************/
            ...
            if (val_inserito == BigInteger.ZERO) {
                ...
                while (esponente >= 0) {
                    ...
                    n = 0;
                    esponente--;
                }  //vett_hex[0] = d2h(val_inserito);
                //scrivo stringa hex da stampare
                tempH = "";
                tempB = "";
                tempOct = "";
